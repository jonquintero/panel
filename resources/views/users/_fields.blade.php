...
<div class="form-group">
    ...
    <textarea class="form-control" name="bio" id="bio" placeholder="Programador">{{ old('bio', $user->profile->bio) }}</textarea>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="twitter" class="form-control" name="twitter" id="twitter" placeholder="https://twitter.com/username" value="{{ old('twitter',  $user->profile->twitter) }}">
</div>
<h5>Habilidades</h5>
